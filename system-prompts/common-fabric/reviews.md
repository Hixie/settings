...
review. [Give subagents their own worktrees](review-subagent-isolation.md). Name worktrees and patch files after 
birds, do not name them "forward" and "reverse" or similar (as that would tell the subagents which was which).
