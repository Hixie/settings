...
These labs copies are [parallel](labs-parallel-copies.md); the offset shifts the shell/toolshed/inspector ports 
off their shared base so the running copies don't collide on the same ports.
